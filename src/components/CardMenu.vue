    ...
    <div class="payment">
      ...
      <div class="payment__card-date">
        ...
        <div class="payment__cvc">
          ...
          <input type="password" class="payment__input" maxlength="3" v-model="cardFields.CVC">
        </div>
      </div>

      <h3 class="payment__total">25.52$</h3>
...
export default {
  ...
  computed: {
    ...
    cardMonth() {
      return typeof +this.cardFields.cardMonth === 'number' && this.cardFields.cardMonth > 0 && this.cardFields.cardMonth < 13 ? this.cardFields.cardMonth : 'MM';
    },
    cardYear() {
      return typeof +this.cardFields.cardYear === 'number' && this.cardFields.cardYear > 22 && this.cardFields.cardYear < 30 ? this.cardFields.cardYear : 'YY';
    },
    disabledBtn() { 
